...
function openConnection() {
    ...
    if (endpoint == 'json') endpointType.innerHTML = 'JSON'
    else if (endpoint == 'scm') endpointType.innerHTML = 'Guile Scheme'
    else if (endpoint == 'python') endpointType.innerHTML = 'Python'
    else if (endpoint == 'sexpr') endpointType.innerHTML = 'S-Expressions'
}
